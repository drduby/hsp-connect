...
<head>
    ...
    <title>Passwort zur&#xFC;cksetzen - HSPConnect</title>
...
<div class="reset-page">
    <form class="modal" id="reset-password-form">
        ...
        <div class="mttl">Passwort zur&#xFC;cksetzen</div>
        <div class="msub">Vergib ein neues Passwort f&#xFC;r dein Konto.</div>
        ...
        <div id="reset-password-fields">
            ...
            <input type="password" id="reset-password" placeholder="Mindestens 8 Zeichen" autocomplete="new-password" required>

            <label for="reset-password-confirmation">Passwort wiederholen</label>
            <input type="password" id="reset-password-confirmation" placeholder="Mindestens 8 Zeichen" autocomplete="new-password" required>
            ...
            <button class="mbtn" type="submit">Reset password</button>
            <div class="mlink"><a href="{{ url('/') }}">Zur&#xFC;ck zur Startseite</a></div>
        </div>
        ...
        <div id="reset-password-success" style="display:none">
            ...
            <a class="mbtn" href="{{ url('/?login=1') }}" style="display:block;text-align:center;text-decoration:none">Zur&#xFC;ck zum Login</a>
        </div>
    </form>
</div>
...
function firstResetPasswordError(data) {
    if (data.errors) {
        return Object.values(data.errors)[0]?.[0] || 'Fehler';
    }
...
resetPasswordForm.addEventListener('submit', async function (event) {
    ...
    try {
        ...
        showResetPasswordMessage('Verbindungsfehler. Bitte erneut versuchen.');
    }
});
</script>
</body>
