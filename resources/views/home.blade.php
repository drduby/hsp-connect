...
@section('description', __('ui.home.description'))
    ...
    <div class="layout">
        ...
        <main>
            ...
            <div class="compose">
                ...
                <div id="compose-welcome"
                    ...
                    <div>
                        <div id="compose-welcome-title"
                            ...
                            {{ __('ui.home.welcome_title') }}
                        </div>
                        <div style="font-size:12px;color:var(--muted);line-height:1.65;font-weight:300">{{ __('ui.home.welcome_text') }}</div>
                    </div>
                </div>
                <div style="margin-top:10px">
                    <button class="c-big-btn c-big-btn-e" onclick="checkAuthThen(()=>openPM('Erfahrung'))"
                        ...
                        <span style="font-size:14px;font-weight:700">{{ __('ui.home.share_experience') }}</span>
                    </button>
                </div>
            </div>
            ...
            <div id="feed-empty" class="empty" style="display:none">
                ...
                <div class="empty-t">{{ __('ui.home.no_posts_title') }}</div>
                <p>{{ __('ui.home.no_posts_text') }}</p>
            </div>
