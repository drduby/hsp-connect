@php
    $navItems = [
        ...
        [
            ...
            'label' => 'Translations',
            'icon'  => '<path d="m10.5 21 5.25-11.25L21 21m-9-3h7.5M3 5.621a48.474 48.474 0 0 1 6-.371m0 0c1.12 0 2.233.038 3.334.114M9 5.25V3m3.334 2.364C11.176 10.658 7.69 15.08 3 17.502m9.334-12.138c.896.061 1.785.147 2.666.257m-4.589 8.495a18.023 18.023 0 0 1-3.827-5.802" stroke-linecap="round" stroke-linejoin="round" />',
        ],
        [
            'route' => 'admin.logs.index',
            'label' => 'Logs',
            'icon'  => '<path d="M3.75 9.776c.112-.017.227-.026.344-.026h15.812c.117 0 .232.009.344.026m-16.5 0a2.25 2.25 0 0 0-1.883 2.542l.857 6a2.25 2.25 0 0 0 2.227 1.932H19.05a2.25 2.25 0 0 0 2.227-1.932l.857-6a2.25 2.25 0 0 0-1.883-2.542m-16.5 0V6A2.25 2.25 0 0 1 6 3.75h3.879a1.5 1.5 0 0 1 1.06.44l2.122 2.12a1.5 1.5 0 0 0 1.06.44H18A2.25 2.25 0 0 1 20.25 9v.776" stroke-linecap="round" stroke-linejoin="round" />',
        ],
    ];
@endphp
    ...
    <ul role="list" class="flex flex-1 flex-col gap-y-7">
        ...
        <li class="mt-auto space-y-1">
            <a href="{{ route('admin.password.index') }}"
               class="group -mx-2 flex gap-x-3 rounded-md p-2 text-sm/6 font-semibold {{ request()->routeIs('admin.password.index') ? 'bg-gray-50 text-indigo-600' : 'text-gray-700 hover:bg-gray-50 hover:text-indigo-600' }}">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" aria-hidden="true"
                     class="size-6 shrink-0 {{ request()->routeIs('admin.password.index') ? 'text-indigo-600' : 'text-gray-400 group-hover:text-indigo-600' }}">
                    <path d="M15.75 5.25a3 3 0 0 1 3 3m3 0a6 6 0 0 1-7.029 5.912c-.563-.097-1.159.026-1.563.43L10.5 17.25H8.25v2.25H6v2.25H2.25v-2.818c0-.597.237-1.17.659-1.591l6.499-6.499c.404-.404.527-1 .43-1.563A6 6 0 0 1 21.75 8.25Z" stroke-linecap="round" stroke-linejoin="round" />
                </svg>
                Change Password
            </a>
